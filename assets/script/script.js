...
function myScope() {
    ...
    function renderRes(n) {
        ...
        res.innerHTML += `<p><b>1X:</b> ${n} = R$:${n + n1}</p>` 
        res.innerHTML += `<p><b>2X:</b> ${((n + n2) / 2).toFixed(2)} = R$:${n + n2}</p>`
        res.innerHTML += `<p><b>3X:</b> ${((n + n3) / 3).toFixed(2)} = R$:${n + n3}</p>`
        res.innerHTML += `<p><b>4X:</b> ${((n + n4) / 4).toFixed(2)} = R$:${n + n4}</p>`
        res.innerHTML += `<p><b>5X:</b> ${((n + n5) / 5).toFixed(2)} = R$:${n + n5}</p>`
        res.innerHTML += `<p><b>6X:</b> ${((n + n6) / 6).toFixed(2)} = R$:${n + n6}</p>`
        res.innerHTML += `<p><b>7X:</b> ${((n + n7) / 7).toFixed(2)} = R$:${n + n7}</p>`
        res.innerHTML += `<p><b>8X:</b> ${((n + n8) / 8).toFixed(2)} = R$:${n + n8}</p>`
        res.innerHTML += `<p><b>9X:</b> ${((n + n9) / 9).toFixed(2)} = R$:${n + n9}</p>`
        res.innerHTML += `<p><b>10X:</b> ${((n + n10) / 10).toFixed(2)} = R$:${n + n10}</p>`
        res.innerHTML += `<p><b>11X:</b> ${((n + n11) / 11).toFixed(2)} = R$:${n + n11}</p>`
        res.innerHTML += `<p><b>12X:</b> ${((n + n12) / 12).toFixed(2)} = R$:${n + n12}</p>`
    }
